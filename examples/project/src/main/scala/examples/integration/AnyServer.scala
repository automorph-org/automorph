...
private[examples] object AnyServer {
  ...
  def main(arguments: Array[String]): Unit = {
    ...
    {
      // Retrieve incoming request body (real implementation will be server specific)
      val requestBody =
        """
          |{
          |  "jsonrpc" : "2.0",
      ...
      // Send the response body to the client as a response (real implementation will be HTTP server specific)
