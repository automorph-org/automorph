...
- **Effect handling** - [Asynchronous](https://automorph.org/docs/Examples#asynchronous-call), [Synchronous](https://automorph.org/docs/Examples#synchronous-call), [Monadic](https://automorph.org/docs/Examples#effect-system).
