...
object RpcException {
  ...
  final case class InvalidRequest(message: String, cause: Throwable = None.orNull) extends RpcException(message, cause)

  /** Invalid RPC response error. */
  final case class InvalidResponse(message: String, cause: Throwable = None.orNull) extends RpcException(message, cause)
  ...
  /** Remote server error. */
  final case class ServerError(message: String, cause: Throwable = None.orNull) extends RpcException(message, cause)
