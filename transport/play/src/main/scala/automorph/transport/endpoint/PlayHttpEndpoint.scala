...
import automorph.transport.endpoint.PlayHttpEndpoint.{Context, headerXForwardedFor}
...
final case class PlayHttpEndpoint[Effect[_]](
  ...
  extends EndpointTransport[Effect, Context, Action[ByteString]] with Logging {
