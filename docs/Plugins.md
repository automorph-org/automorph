...
| --- | --- | --- | --- |
| [IdentitySystem](https://automorph.org/api/automorph/system/IdentitySystem.html) (Default) | [automorph-standard](https://central.sonatype.com/artifact/org.automorph/automorph-standard_3) | [Standard](https://docs.scala-lang.org/scala3/book/taste-functions.html) | [Identity](https://scala-lang.org/api/3.x/scala/Predef$.html#identity-957) |
| [TrySystem](https://automorph.org/api/automorph/system/TrySystem.html) | [automorph-standard](https://central.sonatype.com/artifact/org.automorph/automorph-standard_3) | [Standard](https://docs.scala-lang.org/scala3/book/fp-functional-error-handling.html) | [Try](https://www.scala-lang.org/files/archive/api/3.x/scala/util/Try.html) |
| [FutureSystem](https://automorph.org/api/automorph/system/FutureSystem.html) (*Default*) | [automorph-standard](https://central.sonatype.com/artifact/org.automorph/automorph-standard_3) | [Standard](https://docs.scala-lang.org/overviews/core/futures.html) | [Future](https://scala-lang.org/api/3.x/scala/concurrent/Future.html) |
...
| [UrlClient](https://automorph.org/api/automorph/transport/http/client/UrlClient.html) | [automorph-standard](https://central.sonatype.com/artifact/org.automorph/automorph-standard_3) | [Standard](https://docs.oracle.com/javase/8/docs/api/java/net/HttpURLConnection.html) | [HTTP](https://en.wikipedia.org/wiki/HTTP) |
