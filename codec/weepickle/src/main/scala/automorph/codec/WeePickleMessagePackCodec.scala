...
import automorph.codec.messagepack.{WeePickleJsonRpc, WeePickleOpenApi, WeePickleOpenRpc, WeePickleWebRpc}
import automorph.codec.meta.WeePickleMessagePackMeta
